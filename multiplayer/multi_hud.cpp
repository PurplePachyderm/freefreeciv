...
//Multiplayer equivalent to "display/hud_display.c"
//XXX WIP
...
void mBuildingDisplay(SDL_Renderer * renderer, SDL_Texture * texture, struct game game, view camera, int countdown, int buildingId){
	basicDisplay(renderer, texture, game, camera, countdown, 0);
